function processApplicantData_(request, context) {
  ...
  var actorEmail = String(context && context.email || readActiveUserEmailFromSession_() || '').trim();
  ...
  return withOperationWriteLock_(function () {
    ...
    writeBusinessAudit_({
      ...
      beforeValue: {
        ...
        managerEmail: String(applicant.managerEmail || ''),
