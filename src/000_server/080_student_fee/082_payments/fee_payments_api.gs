...
function api_getFeeApplicationList(input) {
  return apiHandler_({
    operation: 'getFeeApplicationList',
    input: input,
    requireLogin: true,
    parse: parseStudentFeeRequest_,
...
function api_getFeeApplicationDetail(input) {
  return apiHandler_({
    operation: 'getFeeApplicationDetail',
    input: input,
    requireLogin: true,
    parse: parseStudentFeeRequest_,
...
function api_processFeeApplications(input) {
  return apiHandler_({
    operation: 'processFeeApplications',
    input: input,
    requireLogin: true,
    parse: parseStudentFeeRequest_,
