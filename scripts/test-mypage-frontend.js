...
assert.ok(client.indexOf("api_getCurrentUser") !== -1, 'MyPage must consume api_getCurrentUser');
assert.ok(client.indexOf("api_getMyPermissions") !== -1, 'MyPage must consume api_getMyPermissions');
