...
var detailPath = path.join(ROOT, 'src/frontend/pages/event_detail/Event_Detail.html');
var syncPath = path.join(ROOT, 'src/frontend/features/event_form_sync/event_form_sync_js.html');
var clientPath = path.join(ROOT, 'src/frontend/entities/event/api/event_client_js.html');
...
assert.ok(/include\(['"]frontend\/features\/event_form_sync\/event_form_sync_js['"]\)/.test(detailSource), 'Event Detail must include focused Forms module');
assert.ok(/include\(['"]frontend\/entities\/event\/api\/event_client_js['"]\)/.test(detailSource), 'Event Detail must load semantic Event client');
