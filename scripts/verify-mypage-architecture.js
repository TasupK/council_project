...
['frontend/shared/styles/App_Styles','frontend/widgets/app_header/App_Header','frontend/widgets/app_sidebar/App_Sidebar','frontend/shared/api/rpc/app_api_runner_js','frontend/entities/user/api/app_client_js','frontend/app/shell/app_shell_js'].forEach(function (includePath) { if (page.indexOf(includePath) === -1) failures.push('MyPage must reuse FSD foundation include: ' + includePath); });
...
var protectedSources = ['src/backend/core/auth','src/backend/domains/iam','src/backend/app/routing','src/frontend/pages/login','src/frontend/pages/mypage','src/frontend/features/notification_settings'].reduce(function (sources, relativePath) { return sources.concat(listFiles_(path.join(ROOT, relativePath))); }, []);
