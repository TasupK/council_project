...
assert.ok(query.includes('function toDepartmentDto_'), 'toDepartmentDto_ missing');
assert.ok(query.includes('function getDepartmentsById_'), 'getDepartmentsById_ missing');
